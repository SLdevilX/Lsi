...
if (Config.WORKTYPE == 'private') {
        ...
        Xlt.addCommand({pattern: 'grp', fromMe: true, deleteCommand: false,}, (async (message, match) => {
...
if (Config.WORKTYPE == 'public') {
        ...
        Xlt.addCommand({pattern: 'grp', fromMe: false, deleteCommand: false,}, (async (message, match) => {
