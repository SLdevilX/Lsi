...
if (Config.WORKTYPE == 'private') {
    ...
    Xlt.addCommand({pattern: 'rmbg ?(.*)', fromMe: true, desc: Lang.REMOVEBG_DESC}, (async (message, match) => {    
    ...
    Xlt.addCommand({pattern: 'rmbg ?(.*)', fromMe: false, desc: Lang.REMOVEBG_DESC}, (async (message, match) => {    
