...
if (Config.WORKTYPE == 'private') {
    ...
    Xlt.addCommand({pattern: 'mp4audio', fromMe: true, desc: Lang.MP4TOAUDİO_DESC}, (async (message, match) => {    
    ...
    Xlt.addCommand({pattern: 'stoimg', fromMe: true, desc: Lang.STİCKER_DESC}, (async (message, match) => {   
    ...
    Xlt.addCommand({pattern: 'mp4audio', fromMe: false, desc: Lang.MP4TOAUDİO_DESC}, (async (message, match) => {    
    ...
    Xlt.addCommand({pattern: 'stoimg', fromMe: false, desc: Lang.STİCKER_DESC}, (async (message, match) => {    
