...
Xlt.addCommand({on: 'text', fromMe: wk, dontAddCMDList: true, deleteCommand: false}, (async (message, match) => {
...
Xlt.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
...
Xlt.addCommand({ pattern: 'liza ?(.*)', desc: fulleva_dsc, fromMe: true, usage: '.liza on / off' }, (async (message, match) => {
