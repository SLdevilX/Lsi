...
Xlt.addCommand({on: 'text', fromMe: true, deleteCommand: false}, (async (message, match) => {
...
Xlt.addCommand({pattern: 'afk ?(.*)', fromMe: true, deleteCommand: false, desc: Lang.AFK_DESC}, (async (message, match) => {     
    if (!AFK.isAfk) {
