...
if (Config.WORKTYPE == 'private') {
    ...
    Xlt.addCommand({pattern: 'weather ?(.*)', desc: Lang.WEATHER_DESC, fromMe: true}, async (message, match) => {
...
if (Config.WORKTYPE == 'public') {
    ...
    Xlt.addCommand({pattern: 'weather ?(.*)', desc: Lang.WEATHER_DESC, fromMe: false}, async (message, match) => {
