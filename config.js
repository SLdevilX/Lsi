...
DATABASE_URL = process.env.DATABASE_URL === undefined ? './Xlite.db' : process.env.DATABASE_URL;
...
module.exports = {
    ...
    DATABASE: DATABASE_URL === './Xlite.db' ? new Sequelize({ dialect: "sqlite", storage: DATABASE_URL, logging: DEBUG }) : new Sequelize(DATABASE_URL, { dialectOptions: { ssl: { require: true, rejectUnauthorized: false } }, logging: DEBUG }),
